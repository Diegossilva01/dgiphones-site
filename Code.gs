const CONFIG={TIMEZONE:'America/Sao_Paulo',TOKEN_HORAS:8,COMISSAO_PERCENTUAL:0.02,ABAS:{FUNCIONARIOS:'Funcionarios',COMPRAS:'Compras',ESTOQUE:'Estoque',VENDAS:'Vendas',LOG:'LogExclusoes',COTACOES:'CotacoesSite',PAGAMENTOS:'PagamentosEquipe',VALES:'ValeSolicitacoes'}};
