...
const state={token:localStorage.getItem("ct_token")||"",user:null,chart:null,estoque:[],historico:[],dados:null,funcionarios:[],revendedores:[],financeiro:null};
...
const ACOES_RETRY_SEGURO=new Set([
  ...
  'listarFinanceiroEquipe','listarVendasComissao','listarVales','listarRevendedores'
]);
...
$$('#vendaForm input[type=date],#compraForm input[type=date]').forEach(i=>{if(!i.value)i.value=today()});
